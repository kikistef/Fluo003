...
import { MeshStandardMaterial, MeshPhysicalMaterial, ShaderMaterial  } from 'three';
...
if (materials) {
  ...
  materials['Mat.006'] = new MeshStandardMaterial({
    ...
    roughness: 0.0, // Valeur de rugosité entre 0 (lisse) et 1 (rugueux)
	  
	 
	 // transmission: 0,
	 // thickness: 1.8,
	   color: '#03bafc', //#03bafc //#03bafc
  });
